...
enum SINAIS {PONTO_VIRG = 1, DOIS_PONTOS, DIVISAO,  ATRIBUICAO, ADICAO, SUBTRACAO, MULTIPLICACAO, DIVISAO, MODIFICADOR,
 A_PARANETESE, F_PARENTESE, A_CHAVE, F_CHAVE, MAIOR, MENOR, A_COLCHETE, F_COLCHETE, AND, NAO, VIRGULA, OU, 
 IDENTIF_PONTEIRO, ASPAS_S, ASPAS_D, PONTO, COMPARACAO, DIFERENCA, MAIOR_IGUAL, MENOR_IGUAL, NAO_IGUAL}; //completar com nomes de códigos correspondentes sinais restantes de MinObjC 
